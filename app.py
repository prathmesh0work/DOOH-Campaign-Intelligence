...
def upload_file():
    try:
        ...
        if file_extension not in ["csv","xlsx","xls"]:
            return json_response({"success": False,"error":"Please upload a CSV, XLS, or XLSX file."},400)
...
def file_too_large(error):
    return json_response({"success": False,"error":"File is too large. Please upload a file under 25MB."},413)
